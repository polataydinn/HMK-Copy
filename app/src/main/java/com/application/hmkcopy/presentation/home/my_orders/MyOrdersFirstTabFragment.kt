...
import com.application.hmkcopy.databinding.FragmentMyOrdersFirstTabBinding
...
@AndroidEntryPoint
class MyOrdersFirstTabFragment : BaseFragment<FragmentMyOrdersFirstTabBinding, CommonViewModel>() {
    ...
    override fun layoutResource(
        ...
        container: ViewGroup?
    ): FragmentMyOrdersFirstTabBinding {
        return FragmentMyOrdersFirstTabBinding.inflate(inflater, container, false)
    }
